...
import (
	...
	"github.com/DNAProject/DNA/enet/common/set"
	"github.com/DNAProject/DNA/enet/message/msg_pack"
	"github.com/DNAProject/DNA/enet/message/types"
	"github.com/DNAProject/DNA/enet/net/protocol"
	"github.com/DNAProject/DNA/enet/peer"
)
...
func (this *NetServer) init() error {
	...
	this.connectingNodes.ConnectingAddrs = set.NewSet()
	this.inConnRecord.InConnectingAddrs = set.NewSet()
	this.outConnRecord.OutConnectingAddrs = set.NewSet()
